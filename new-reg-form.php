...
/*
  ...
  Description: Custom Registration Form for http://uberlin.com.ua/
  Version: 1.0
...
function custom_registration_submit_ajax()
{
	...
	$reg_error = registration_validation( $name , $lname , $fname , $email , $phonenumber , $city , $payType , $bankCard , $personalData , $carMark , $carModel , $carColor , $carYear , $carNumber , $file );

	if ( count( $reg_error ) == 0 ) {
		$response = complete_registration( $name , $lname , $fname , $email , $phonenumber , $city , $payType , $bankCard , $carMark , $carModel , $carColor , $carYear , $carNumber , $file );

		if ( $response['user']->result == 'ok' ) {
...
//                        console.log('error');
//                        jQuery('#modal-text').text(JSON.stringify(response));
//                        jQuery('#myModal').css('display','block');
//
...
{
	$respons = '<div id="errors"></div>
<div class="acf-form" >
	<div class="acf-fields acf-form-fields -top">';
	$respons .= '<div id="tabs" class="acf-tab-wrap -top">
            <ul class="acf-hl acf-tab-group">
                <li><a href="#tabs-1" class="acf-tab-button">Информация (Шаг 1)</a></li>
                <li><a href="#tabs-2" class="acf-tab-button">Об автомобиле(Шаг 2)</a></li>
            </ul>
            ';
	$respons .= '
            <div id="tabs-1">
    ...
    <div class="acf-field acf-field-text">
        <div class="acf-input">
            <div class="acf-input-wrap">
                ...
                <input id="bankCard" type="text" name="bankCard" maxlength="16" placeholder="' . $local['bankCard'] . '"
                       value=""/>
            </div>
        </div>
    </div>
    ...
    <div>
        <input style="width: 10% !important;" type="checkbox" id="personalData" name="personalData" value=""/>
...
<div class="acf-form-submit">
    <input class="acf-button button button-primary button-large" type="button" name="buttonSubmit" id="buttonSubmit"
           value="Регистрация"/>
</div>
    <!-- The Modal -->
...
function registration_validation(
	$name , $lname , $fname , $email , $phonenumber , $city , $payType , $bankCard , $personalData , $carMark , $carModel , $carColor , $carYear , $carNumber , $file
) {
	$reg_errors = [];
...
function complete_registration(
	$name , $lname , $fname , $email , $phonenumber , $city , $payType , $bankCard , $carMark , $carModel , $carColor , $carYear , $carNumber , $file
) {
